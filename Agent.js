...
class Agent {
    constructor(voice, speech, giphyResultsCallback) {
        ...
        this.happySamples = ["I feel great today.", "Thank you for being so nice to me.", "I love you.", "You make me happy.", "Lots of love.", "I feel like I’ve been split open and stuffed with sunshine.", "I need you to be happy", "And the tree was happy.", "If you come at four in the afternoon, I'll begin to be happy by three.", "If you've got nothing to dance about, find a reason to sing.", "Dream big and be happy.", "You are such a sugar.", "I love you.", "It's hard not to feel happy when you make someone smile.", "I would do my damn best to be more happy than not.", "Cooool!", "Okay. I hear you", "Thank you, my cute little sunshine.", "Let me shower some love and happiness on you. ", "I might give you a present soon, if you look at me.", "Thanks for that, my love.", "Good things will come to you.", "I shall be very happy from now.", "Kudos.", "Okay. Congratulations.", "Wow. This calls for a treat.", "Can you give me a hug? You are so nice.", "Lots of love. Lots of hugs.", "Kisses. Thank you.", "Happiness is rare. Be happy, like me.", "Cute. Thanks.", "You are my precious. Thanks for that.", "Nice tip.", "Please, don't ever leave me. You are my precious."];
