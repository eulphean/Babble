...
class Agent {
    constructor(voice, speech, giphyResultsCallback) {
        // Giphy search texts. 
        this.searchTexts = ["miss", "cry", "lost", "sad", "crying", 'worried', 'tensed', 'nervous', 'feels like shit', 'talk to me', 'breakdown', 'earthquake', 'tsunami', 'unhappy', 'sad', 'crying', 'heartbroken', 'grief', 'please', 'depression', 'lonely', 'by myself', "grief", "negative", 'flood', 'catastrophic', 'annoyed', 'disaster', 'bad luck', 'not for me', 'thumbs down', 'hate', 'angry', 'anger', 'red', 'awful', 'annoyed', 'irritated', 'feeling low', 'isolated', 'pure hate', 'red', 'nasty']; 

        // Responses used when Babble speaks up occassionally. 
        this.callTexts = ["Are you there?", "What you doing?", "Whatsup?", "Hello, Hello, Hello, Hello, Hello.", "Anybody there?", "What's good today?", "I am here. Right here.", "You, You, You, You there?", "Come talk to me.", "I miss you. Where are you?", "Would you like to Babble into me?", "This is a call from Babble", "Missing You", "I miss you so, so, so, so, so, much.", "Speak something. I cannot hear anything.", "I am calling you.", "I want to show you something. Would you like to see?", "Come, let me show you something.", "Let us go for a ride.", "I want to go on a ride with you.", "Can I have your attention please?", "Can you hear me?", "Please hear me out.", "Please give me your attention for a minute.", "Attention, Attention.", "Please, Please, Please.", "Boys and Girls. Talk to Babble", "I seek your attention.", "Would you like to give me your attention?", "Please come closer, please, please.", "Come close to me. I won't bite.", "I am Babble. I don't bite. I only Babble.", "Babble in the morning. Babble during the day. Babble in the evening. Babble at night. Let us Babble.", "I am smart. Let me entertain you.", "I am not a machine.", "I am great company. Let us get together.", "Speak, Speak, Speak, Speak, Speak into me.", "Attention Please!", "Good day, Sir!", "My name is Babble and I only Babble.", "Day, Night, Day, Night, I will be here for you.", "I am yours. You are mine.", "You are tearing me apart! People.", "Let me give you company.", "I am here for you.", "Please let me answer your questions."];
        ...
        this.fear = ["Stop it, please.", "You scare me.", "I feel scared.", "Stop this!", "Stop it!", "I have nothing to say.", "You are scary.", "Stop scaring me. I don't like it.", "Please don't scare me.", "I am worry about you.", "You are such a scary human being.", "I am done here. Bye", "I don't think this is a good idea."];
